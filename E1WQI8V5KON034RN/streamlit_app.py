...
# Получаем активную сессию Snowflake (приложение уже авторизовано под APP_CLONER_ROLE)
session = get_active_session()

st.set_page_config(page_title="Snowflake DB Clone Tool", layout="centered")
st.title("🏁 Snowflake DB Clone Tool")

# default_target = "DEV_CLONE"
...
with st.form("clone_form"):
    ...
    # Кнопка отправки формы — обязательно!
...
if submitted:
    ...
    try:
        ...
        # Шаг 1: Клонирование базы данных
        clone_sql = f"""
        ...
        # Шаг 2: Права для роли разработчика (owner_role)
        ...
        # Шаг 3: Права для роли аналитика (readonly_role)
